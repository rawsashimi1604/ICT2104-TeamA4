...
static volatile uint16_t DEFAULT_DC = 1250; // 100% Duty Cycle // 1250 = 100%
...
const uint8_t STRAIGHT_TICKS = 25; // Number of ticks required to move 1 grid
...
Timer_A_PWMConfig left_wheel_PWM_config =
{
    ...
    TIMER_A_CLOCKSOURCE_DIVIDER_3,    // SMCLK / 64 = 38kHz, period = 1/38khz = 0.026ns
    1250, // 30000                             // Tick Period
    TIMER_A_CAPTURECOMPARE_REGISTER_2, // CCR2
    TIMER_A_OUTPUTMODE_RESET_SET,      // Compare Output Mode
    1250 // 15000                              // Duty Cycle
};
...
void Motor_init(void)
{
    ...
    GPIO_setAsPeripheralModuleFunctionOutputPin(GPIO_PORT_P2, GPIO_PIN4, GPIO_PRIMARY_MODULE_FUNCTION); // Configuring the peripheral module function in the output direction for P2.4 for primary module function modes
    /* PWM port for left motor */
    GPIO_setAsPeripheralModuleFunctionOutputPin(GPIO_PORT_P2, GPIO_PIN5, GPIO_PRIMARY_MODULE_FUNCTION); // Configuring the peripheral module function in the output direction for P2.5 for primary module function mod
