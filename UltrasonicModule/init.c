...
initPortsAndPins()
{
    ...
    GPIO_setAsInputPinWithPullDownResistor(ULTRASONIC_ECHO_PORT1,
                                           ULTRASONIC_ECHO_PIN1);
    GPIO_setAsInputPinWithPullDownResistor(ULTRASONIC_ECHO_PORT2,
                                           ULTRASONIC_ECHO_PIN2);
    GPIO_setAsInputPinWithPullDownResistor(ULTRASONIC_ECHO_PORT3,
                                           ULTRASONIC_ECHO_PIN3);
    GPIO_setAsInputPinWithPullDownResistor(ULTRASONIC_ECHO_PORT4,
